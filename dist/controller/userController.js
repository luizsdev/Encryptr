    ...
    bcrypt.genSalt(10, function (err, salt) {
        bcrypt.hash(stringed, salt, function (err, hash) {
            if (err) {
                ...
                db_1["default"].create({ info: stringed, hash: hash, code: substring });
...
var decrypt = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var code, user, whatToSend;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                code = req.params.code;
                return [4 /*yield*/, db_1["default"].findOne({ code: code })];
            case 1:
                user = _a.sent();
                if (user) {
                    whatToSend = "Here's your info -> " + user.info;
                    res.send(whatToSend);
                }
                else {
